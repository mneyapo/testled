...
boucle_compteur = 0                     # utilisé comme compteur de passages dans la boucle principale
...
# Bus GPIO
# LED
GPIO_LEDR = 36          # LED Rouge
GPIO_LEDV = 32          # LED Verte
